...
public class MainTopologiaDois {
	...
	public static void main(String[] args) {
		...
		String macRouter2 = "00:00:00:00:00:R3";
		String macRouter3 = "00:00:00:00:00:R4";
		...
		AltingChannelInput[] routerIns = {chan0B.in(),chanR2.in(),chanR3.in()};
		...
		CSProcess router = new Router("Roter R0", macRouter, routerIns, routerOuts, rt,routerIPports);

		//FIX AND ADD OTHERS ROUTERS
		RouterTable rt1 = new RouterTable();
		String[] routerIPports1 = {"10.0.3.2","10.0.4.2","10.0.10.2"};
		MTUOut[] routerOuts1 = {new MTUOut(15,chan2A.out()),new MTUOut(5,chan3A.out()),new MTUOut(15,chanR1.out())};
